...
public class Queen extends Piece {
	...
	public static final PieceTypes type = PieceTypes.QUEEN;
	...
	public Queen(Side affiliation, int xCoord, int yCoord, ChessBoard b) {
		this.xPos = xCoord;
		this.yPos = yCoord;
		this.b = b;
		...
		if (affiliation == Side.BLACK) {
			this.graphic = "files/bQueen.png";
		}
		else {
			this.graphic = "files/wQueen.png";
		}
	...
	public LinkedList<ChessSquare> validSquares() {
		...
		squareSet = ChessHelpers.diag1(this.xPos, this.yPos,
				squareSet, grid, this.team);
		squareSet = ChessHelpers.diag2(this.xPos, this.yPos,
				squareSet, grid, this.team);
		squareSet = ChessHelpers.getHorizontal(this.xPos, this.yPos,
				squareSet, grid, this.team);
		squareSet = ChessHelpers.getVert(this.xPos, this.yPos,
				squareSet, grid, this.team);
