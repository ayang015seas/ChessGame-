...
public class Rook extends Piece {
	...
	public static final PieceTypes type = PieceTypes.ROOK;
	...
	public Rook(Side affiliation, int xCoord, int yCoord, ChessBoard b) {
		this.xPos = xCoord;
		this.yPos = yCoord;
		this.b = b;
		...
		if (affiliation == Side.BLACK) {
			this.graphic = "files/bRook.png";
		}
		else {
			this.graphic = "files/wRook.png";
		}
