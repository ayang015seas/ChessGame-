...
public class Bishop extends Piece {
	...
	public static final PieceTypes type = PieceTypes.BISHOP;
	...
	public Bishop(Side affiliation, int xCoord, int yCoord, ChessBoard b) {
		this.xPos = xCoord;
		this.yPos = yCoord;
		this.b = b;
		...
		if (affiliation == Side.BLACK) {
			this.graphic = "files/bBishop.png";
		}
		else {
			this.graphic = "files/wBishop.png";
		}
