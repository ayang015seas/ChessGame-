...
public class Knight extends Piece {
	...
	public static final PieceTypes type = PieceTypes.KNIGHT;
	...
	public Knight(Side affiliation, int xCoord, int yCoord, ChessBoard b) {
		this.xPos = xCoord;
		this.yPos = yCoord;
		this.b = b;
		...
		if (affiliation == Side.BLACK) {
			this.graphic = "files/bKnight.png";
		}
		else {
			this.graphic = "files/wKnight.png";
		}
	...
	public LinkedList<ChessSquare> validSquares() {
		...
		squareSet = ChessHelpers.knightSquares(this.xPos, this.yPos,
